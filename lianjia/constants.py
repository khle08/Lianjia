...
newhouse_analysis_form = [(0, '请选择维度:'), (1, '每平米价位占比'), (2, '每套房价位占比'),
                          (3, '每平米均价'), (4, '每套房均价'),
                          (5, '物业占比分布'), (6, '户型占比分布'),
...
ershoufang_analysis_form = [(0, '请选择维度:'), (1, '每平米价位占比'), (2, '每套房价位占比'), (3, '每平米均价'),
...
ershoufang_analysis_map = {1: '每平米价位占比', 2: '每套房价位占比',
                           ...
                           7: ' 热门小区词云', 8: '热门地段词云'}
rent_analysis_form = [(0, '请选择维度:'), (1, '每个品牌房源占比'), (2, '房源占比最高的top5均价'),
                      (3, '每平米均价'),
